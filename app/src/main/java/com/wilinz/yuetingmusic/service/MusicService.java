...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    private void createMediaSession(){
        ...
        stateBuilder = new PlaybackStateCompat.Builder()
                ...
                .setActions(MediaPlayerSessionCallback.getAvailableActions(PlaybackStateCompat.STATE_NONE));
    ...
    public BrowserRoot onGetRoot(@NonNull String clientPackageName, int clientUid, @Nullable Bundle rootHints) {
        ...
        mediaPlayerSessionCallback.sendMetadata();
    ...
    public void onLoadChildren(@NonNull String parentId, @NonNull Result<List<MediaBrowserCompat.MediaItem>> result) {
        ...
        // 例如假设音乐目录已经加载缓存。
        result.sendResult(CollectionsKt.map(PlayQueue.getInstance().getRawQueue(), Song::mapToMediaItem));
    }
